...
5. Mỗi lần đổi tính năng lớn: cập nhật **PROGRESS.md**, **PRIVACY.md**, **FAQ.md**, `version.json`.

---

## 6. Lịch sử phiên bản gần (rút gọn)
...
| 0.14.1+ | Hướng dẫn Cộng đồng **tách 2 nhóm**; MD đầy đủ trở lại |
